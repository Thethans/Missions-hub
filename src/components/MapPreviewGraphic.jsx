...
import mapOutlines from '../data/mapOutlines.json';
...
// parallels without needing to run that projection here too.
const VIEW_W = 800;
const VIEW_H = 400;
...
// reaches /map. Country outlines (mapOutlines.json, generated by
// scripts/generate-map-outlines.js from world-atlas's real Natural Earth
// data, projected through the same project() the dots use) give the dot
// scatter a coastline/border reference instead of reading as a sparse
// pattern with no geographic anchor.
export default function MapPreviewGraphic() {
  return (
    ...
    >
      <Graticule />
      <path className="map-preview-outline" d={mapOutlines.path} aria-hidden="true" />
